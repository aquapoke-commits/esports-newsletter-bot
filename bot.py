...
TARGET_CHANNELS = [
    ...
    1484470245660823552, # GGX MATE
    1488010556022587402, # EAPOD
    # 987654321098765432, 
]
...
NORMAL_KEYWORDS = [
    ...
    "LoL", "League of Legends", "Valorant", "이터널 리턴", "PUBG", "FC Online", "스타크래프트", "나혼렙", "마블 라이벌즈", "리프트바운드", "섀도우버스", "철권", "스트리트 파이터", "로켓 리그", #종목명
    "라이엇", "넷마블", "크래프톤", "블리자드", "넥슨", #종목사
    "World Championship", "롤드컵", "MSI", "퍼스트 스탠드", "VCT", "PWS", "PGS", "PGC", "EWC", "ENC", #국제 대회명
...
IGNORE_DUPLICATE_WORDS = ["Esports", "이스포츠", "e스포츠", "2025", "2026", "경기", "리그", "vs", "오늘", "내일", "Insider", "데일리e스포츠", "중앙이코노미뉴스", "웹이코노미", "osen.co.kr", "키움 DRX", "v.daum.net", "크래프톤", "한화생명" ]
